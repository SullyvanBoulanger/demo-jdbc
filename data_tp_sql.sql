-- Création des tables
CREATE TABLE ARTICLE (ID int NOT NULL AUTO_INCREMENT PRIMARY KEY, REF varchar(13) NOT NULL, DESIGNATION varchar(255) NOT NULL, PRIX decimal(7,2) NOT NULL, ID_FOU int NOT NULL);
CREATE TABLE FOURNISSEUR (ID int NOT NULL AUTO_INCREMENT PRIMARY KEY, NOM varchar(25) NOT NULL);
...
Insert into ARTICLE (REF, DESIGNATION, PRIX, ID_FOU) values ('D01', 'Boulon laiton 5 x 40 mm (sachet de 10)', 4.4, 3) ;
Insert into ARTICLE (REF, DESIGNATION, PRIX, ID_FOU) values ('A02', 'Meuleuse 125mm', 37.85, 1) ;
Insert into ARTICLE (REF, DESIGNATION, PRIX, ID_FOU) values ('D03', 'Boulon acier zingué 4 x 40mm (sachet de 10)', 1.8, 3) ;
